import type {BookDetailResponse, BookSearchResponse, Isbn13} from '@nearby-library-search/contracts';
import {requestGet} from '@/shared/request';
import {BOOK_SEARCH_PAGE_SIZE, type BookSearchParams} from '../model/bookSchema';

async function getBooks({title, author, isbn13, page}: BookSearchParams) {
