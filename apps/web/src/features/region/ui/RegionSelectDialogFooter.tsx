...
function RegionSelectDialogFooter() {
  ...
  return (
    <DialogFooter className="border-line mt-4 flex flex-col items-start gap-4 border-t px-4 pt-5 pb-[max(env(safe-area-inset-bottom),1rem)] sm:flex-row sm:items-center sm:justify-between sm:pb-0">
