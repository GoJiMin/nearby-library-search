...
function LibrarySearchResultSelectedDetails({params}: LibrarySearchResultSelectedDetailsProps) {
  ...
  return <LibrarySearchResultDetails library={currentSelectedLibrary} />;
}
