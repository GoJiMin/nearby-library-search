  ...
  return (
    <DialogPrimitive.Overlay
      className={mergeClassNames(
        'fixed inset-0 z-50 bg-slate-950/24 backdrop-blur-[2px]',
        className
      )}
      ref={ref}
      {...props}
...
function DialogHeader({
  ...
  return (
    <div
      className={mergeClassNames('flex flex-col gap-2 text-left', className)}
      {...props}
    />
  )
}
...
>(function DialogDescription({ className, ...props }, ref) {
  return (
    <DialogPrimitive.Description
      className={mergeClassNames(
        'text-text-muted text-sm leading-6',
        className
      )}
      ref={ref}
      {...props}
