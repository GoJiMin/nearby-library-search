const publicEnvKeys = ['VITE_APP_ENV', 'VITE_KAKAO_MAP_APP_KEY', 'VITE_API_BASE_URL'] as const;
...
export {apiConfig, appConfig, hasPublicEnv, kakaoMapConfig, publicEnvKeys, readPublicEnv};
